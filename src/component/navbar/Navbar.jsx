    ...
    return (
        <div className='bg-bgColor ' >
            ...
            <div className="relative ">
                <div className=' bg-bgColor py-4 md:hidden w-[90%] mx-auto mt-5'>
                    <div className='flex justify-between items-center'>
                        <div className=''>
                            <Link to="/" className='border-2 border-black text-3xl px-5 py-1 font-bold'>FRAIS</Link>
                        </div>
                ...
                {/* Side Menu (overlay) */}
                <div className={`fixed top-0 left-0 h-full bg-section3 w-screen z-50 transform ${isMenuOpen ? "translate-y-0" : "-translate-y-full"} transition-transform duration-300 ease-in-out`}>
                    <div className=''>
                        {/* Log In section */}
                        <div className='flex justify-end relative '>
                            <HiX className='text-4xl absolute top-16 right-8 ' onClick={toggleMenu} />
                        </div>()

                        <div className='flex pl-20 text-3xl  flex-col justify-center relative  mt-16 gap-8'>
                            <div className='flex items-center'>
                                <IoPersonCircleSharp className='text-4xl gap-5' />
                                <p className='cur ml-2'><Link to="/login">Log In</Link></p>
                            </div>
